 ...
 * @author omar
 */
public class CrearViajesController implements Initializable {
    ...
    @FXML
    private ComboBox<String> cmbLocomotora;
    ...
    public void setTrenes(ArrayList<Trenes> trenes) {
        ...
        // TODO: 
        // Cambiar cagaderos
        ObservableList <String> modeloLocomotoras = FXCollections.observableArrayList();
        for (int i  = 0; i < trenes.size(); i++) {
            Trenes temp = trenes.get(i);
            modeloLocomotoras.add(temp.getModelo());
            cmbLocomotora.setItems(modeloLocomotoras);
        }
