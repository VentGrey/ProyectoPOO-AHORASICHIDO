 ...
 * @author omar
 */
public class BuscarTrenesController implements Initializable {

    ArrayList<Trenes> trenes = null;
    ArrayList<Trenes> Modelotmp = new ArrayList<>();
    ArrayList<Trenes> IDtmp = new ArrayList<>();
    int pointer = 0;
    ...
    @FXML
    private void buscar_Nombre(ActionEvent event) {
        try {
    ...
    @FXML
    private void buscar_id(ActionEvent event) {
        try {
            limpiar();
            txtModelo.setText("");
