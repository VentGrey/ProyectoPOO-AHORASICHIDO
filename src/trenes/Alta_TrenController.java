 ...
 * @author omar
 */
public class Alta_TrenController implements Initializable {
    
    ArrayList<Trenes> trenes = null; // Lista vacía
    private FXMLDocumentController father;
    ...
    public void setFather(FXMLDocumentController father) {
        this.father = father;
    }
    
    @FXML
    private void cerrar_ventana() {
                this.pane_alta.setVisible(false);
    }

    @FXML
    private void agregar_tren(ActionEvent event) {
                try {
