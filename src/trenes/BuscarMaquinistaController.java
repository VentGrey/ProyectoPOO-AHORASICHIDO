 ...
 * @author omar
 */
public class BuscarMaquinistaController implements Initializable {

    ArrayList<Maquinistas> maquinistas = null;
    ArrayList<Maquinistas> tmp = new ArrayList<>();
    int count = 0;
    ...
    @FXML
    private AnchorPane pane_buscar_maquinista;
    ...
    public void setMaquinistas(ArrayList<Maquinistas> maquinistas) {
        ...
        if (maquinistas.isEmpty() == true) {
            ...
            msg.showAndWait();
            this.pane_buscar_maquinista.setVisible(false);
        }
    ...
    private void Buscar(ActionEvent event) {
        try {
            ...
            for (int j = 0; j < tmp.size(); j++) {
                ...
                lblApMaterno.setText(tmp.get(j).getApMaterno());
                lblAntiguedad.setText(String.valueOf(tmp.get(j)
                        .getAntiguedad()));
    ...
    private void moverRegistro(ActionEvent event) {
        try {
            ...
            if (event.getSource() == btnInicio) {
                ...
                this.lblApMaterno.setText(temp.getApMaterno());
